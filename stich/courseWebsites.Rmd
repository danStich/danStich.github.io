...
**Please note** that links to online data in lecture and homework pages will only work if you are connected to the campus network at SUNY Data for these classes can be downloaded as a compressed folder from <a href="https://github.com/danStich/classData"> this </a> GitHub repository.
