...
Okay, now that you have plotted an awesome histogram to check distributional assumptions, use a Wilcoxon test to determine whether the sampling distributions differ from one another. Can't remember how to do it? See the <a "03_hypothesisTesting.html">lecture module</a>.
...
Conduct a $\chi^2$ test to test for differences in the frequency of high and low osmolality between the presmolt and smolt stages. Use the <a "03_hypothesisTesting.html">lecture module</a> to extract the observed and expected values from the $\chi^2$ test object.
