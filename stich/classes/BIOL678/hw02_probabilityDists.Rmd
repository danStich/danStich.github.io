...
**Question 2.** Calculate the *mean* and *variance* of this distribution using the method of moments. Note that you can write your own function (as in the <a href="02_probabilityDistributions.html>lecture module</a>), or you can use the built-in R functions that we talked about in class this week (see <a href="02_probabilityDistributions.html>lecture module</a>). What are the *mean* and *sd* using this method?  
