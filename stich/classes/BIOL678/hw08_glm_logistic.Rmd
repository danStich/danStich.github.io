...
## Your turn
Next, I want you to strike out on your own and make a couple of models. To start, please **choose at least one additional continuous variable** to add to one of the models above, replacing `Time`.

Fit a model using your new variable(s) in addition to and `Concentration`, and save it to a named object.
