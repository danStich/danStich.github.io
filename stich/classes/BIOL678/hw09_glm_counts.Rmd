...
In addition to these tasks, I would like you to **add or replace at least one explanatory variable** to the model. For example, you could add `width` as a continuous covariate or replace `mass` with `width`. 
...
For your results, it is fine to present model predictions on the standardized scale of the variable.
