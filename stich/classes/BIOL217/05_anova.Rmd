...
_Data analysis_  
We used one-way analysis of variance (ANOVA) to test the effects of treatment group (trt1, trt2, and ctrl) on the mass of plants (g). The null hypothesis for this test was that all group means were equal: $H_0: \mu_1= \mu_2 = \mu_3$. We examined diagnostic plots to assess assumtptions of normality in the residuals, verify homoscedasticity of errors, and determine the presence of inluential observations in the data.
