...
_**Question 3.**_ Which of the explanatory variables are included in the new tree? Go back into the description of the data <a href='../../data/water.pdf'>here</a> to find out what the abbreviations stand for if you need to.
