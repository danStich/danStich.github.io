...
_**Question 3.**_ Which of the explanatory variables are included in the new tree? Go back into the description of the data  [here]("../../data/water.pdf) to find out what the abbreviations stand for if you need to.
