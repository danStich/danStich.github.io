...
Okay, now that you have plotted an awesome histogram to check distributional assumptions, use a Wilcoxon test to determine whether the sampling distributions differ from one another. Can't remember how to do it? See the <a href="04_hypothesisTesting.html">lecture module</a>.
...
**Question 9.** Does this make biological sense based on the description of the dataset above? Does this make statistical sense based on the results of the two-sample t-test above?  
...
Conduct a $\chi^2$ test to test for differences in the frequency of high and low osmolality between the presmolt and smolt stages. Use the <a href="04_hypothesisTesting.html">lecture module</a> to extract the observed and expected values from the $\chi^2$ test object.
