...
**Question 3**. What classes of data are included in your dataframe? Remember your friend, the function `str()`. Show code (this is the last time I’m typing it).
...
**Question 5**. What is the function you used to transform the factor variable to character class?
