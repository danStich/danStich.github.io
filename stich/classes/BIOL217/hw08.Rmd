...
# on the link scale
logit_preds <- data.frame( predict(v.mod, type = "link", se.fit = TRUE) )
...
Finally, let's plot our predictions. Note that here we will plot our raw data as the proportion of zebra mussels dead at a given time and concentration by trial (date).
...
**Question 5.** Use the graph you have created, along with the model results to describe how zebra mussel mortality changed with `Concentration` and `Time`. Be sure to report the relevant test statistics along with your answer.
