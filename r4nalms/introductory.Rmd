...
And, we can write it out to a `.csv` file that we can use to build tables in Excel or Word (or any number of non-Microsoft applications that we also like!).
