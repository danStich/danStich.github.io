...
1. Download the tarball corresponding to the version you want below.<br>
...
# Here is an example using v 1.3.0 - 
# you may need to change the version
install.packages("shadia_1.3.0.tar.gz", repo=NULL, type="source")

# Here is another example using devtools:
devtools::install("path\\to\\shadia-legacy")
```

<h3 id="multi"><b>Previous versions</b></h3>

`shadia` version 1.3.0 (Aug. 2019): <a href="shadia_1.3.0.tar.gz">shadia_1.3.0.tar.gz</a>
