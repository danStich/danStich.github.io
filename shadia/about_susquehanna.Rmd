...
The purpose of this page is to provide a general overview of the Susquehanna River dam passage performance standard model for American shad. If you are looking for examples, please check <a href="examples.html">here</a>.

<h3 id="multi"><b>Habitat definitions</b></h3>

The Susquehanna River Model includes American shad habitat from the Mouth of the Susquehanna River at the Chesapeake Bay. The model currently incorporates upstream passage into the Juniata River (i), the West Branch (ii), the Chemung River (iii), and the North Branch of the Susquehanna River (iv). Upstream and downstream probabilities for using the Stillwater Branch for migration are randomly drawn from distributions based on migration of other species in the river. Probability of using the Piscataquis River is based on proportion of habitat upstream of Howland and West Enfield dams.
...
# Simulate new temperatures for a single year
  newT <- shadia::simTemperature(shadia::tempData_susquehanna)
  plot(newT,
