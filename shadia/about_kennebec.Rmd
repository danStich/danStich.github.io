...
The purpose of this page is to provide a general overview of the Kennebec River dam passage performance standard model for American shad. If you are looking for examples, please check <a href="examples.html">here</a>.

<h3 id="multi"><b>Habitat definitions</b></h3>

The Kennebec River Model includes American shad habitat from Merrymeeting Bay upstream to Abenaki Dam and the Sandy River in the mainstem, and upstream of Burnham Dam in the Sebasticook River.
