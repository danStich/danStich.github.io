...
If you have specific examples you would like to see, please suggest them using the <a href="https://github.com/danStich/shadia/issues">issues tracker</a>, or better yet, submit them as examples based on those provided here.

<h3 id="multi"><b>General use examples</b></h3>

<h4 id="multi"><b><em>"No passage" and "No dams" scenarios</em></b></h4>
...
<h4 id="multi"><b><em>Watershed scale assessment</em></b></h4>
This section will eventually contain some simulation code and some really cool contour plots for watershed-scale applications of the models.

<h4 id="multi"><b><em>Individual dam impacts</em></b></h4>
This section will eventually have sick examples of single-dam investigations, maybe with Milford Dam or Turner's Falls.

<h3 id="multi"><b>River-specific examples</b></h3>

There are no river specific examples just yet. We are focusing initially on general applications. But, should really have some cases for trucking, NMPS in CTR, etc.
